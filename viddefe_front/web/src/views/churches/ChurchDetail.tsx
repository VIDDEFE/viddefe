...
import { useChurch, useWorshipMetrics } from '../../hooks';
import { FiArrowLeft, FiCalendar, FiUsers, FiHome } from 'react-icons/fi';
...
export default function ChurchDetail() {
  ...
  const { data: worshipMetrics } = useWorshipMetrics(id, startTime, endTime);
