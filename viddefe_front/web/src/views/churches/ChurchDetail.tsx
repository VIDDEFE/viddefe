...
import { DateRangeSelector, MetricsStatsGrid, MetricsDetailsGrid } from '../../components/metrics';
import ChurchDetailLayout from '../../components/churches/ChurchDetailLayout';
import { useChurch, useWorshipMetrics, useDateRange } from '../../hooks';
...
export default function ChurchDetail() {
  ...
  // Obtener métricas de cultos de esta iglesia
    ...
    <div className="container mx-auto px-4">
      ...
      */}
      <ChurchDetailLayout church={church} showQuickActions={false}>
        {/* Metrics Section for this Church */}
        {worshipMetrics && (
          <>
            {/* Stats based on Metrics */}
            <MetricsStatsGrid
              totalPeople={worshipMetrics.totalPeople}
              totalGroups={worshipMetrics.totalGroups}
              totalMeetings={worshipMetrics.totalMeetings}
              attendanceRate={worshipMetrics.attendanceRate}
            />
